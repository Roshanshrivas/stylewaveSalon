...
import { deleteSlot, getAllSlots, getAvailableSlots, getSingleSlots, slotCreate, slotsAllUpdate, updateSlotById } from "../controllers/timeSlot.js";
...
router.route("/getSlots").get(getAvailableSlots);
